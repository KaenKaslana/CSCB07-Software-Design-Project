...
public class houseq3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_houseq3);
        ...
        never.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ref.child("Houseq3").setValue("Under 1000 sq. ft");
                Intent i = new Intent(houseq3.this, houseq4.class);
                startActivity(i);
            }
        });
        ...
        occa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ref.child("Houseq3").setValue("1000-2000 sq. ft");
                Intent i = new Intent(houseq3.this, houseq4.class);
                startActivity(i);
            }
        });
        ...
        freq.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ref.child("Houseq3").setValue("Over 2000 sq. ft");
                Intent i = new Intent(houseq3.this, houseq4.class);
                startActivity(i);
            }
        });
