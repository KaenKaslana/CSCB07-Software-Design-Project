...
public class consumptionq1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_consumptionq1);
        ...
        never.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ref.child("Consq1").setValue("Monthly");
                Intent i = new Intent(consumptionq1.this, consumptionq2.class);
                startActivity(i);
            }
        });
        ...
        occa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ref.child("Consq1").setValue("Quarterly");
                Intent i = new Intent(consumptionq1.this, consumptionq2.class);
                startActivity(i);
            }
        });
        ...
        freq.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ref.child("Consq1").setValue("Annually");
                Intent i = new Intent(consumptionq1.this, consumptionq2.class);
                startActivity(i);
            }
        });
        ...
        always.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ref.child("Consq1").setValue("Rarely");
                Intent i = new Intent(consumptionq1.this, consumptionq2.class);
                startActivity(i);
            }
        });
