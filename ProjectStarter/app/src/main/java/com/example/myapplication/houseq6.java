...
public class houseq6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_houseq6);
        ...
        k5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ref.child("Houseq6").setValue("Natural gas");
                Intent intent = new Intent(houseq6.this, houseq7.class);
        ...
        k10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ref.child("Houseq6").setValue("Electricity");
                Intent intent = new Intent(houseq6.this, houseq7.class);
                startActivity(intent);
            }
        });
        ...
        k15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ref.child("Houseq6").setValue("Oil");
                Intent intent = new Intent(houseq6.this, houseq7.class);
                startActivity(intent);
            }
        });
        ...
        k20.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ref.child("Houseq6").setValue("Propane");
                Intent intent = new Intent(houseq6.this, houseq7.class);
                startActivity(intent);
            }
        });
        ...
        k25.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ref.child("Houseq6").setValue("Wood");
                Intent intent = new Intent(houseq6.this, houseq7.class);
                startActivity(intent);
            }
        });
        ...
        more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ref.child("Houseq6").setValue("Other");
                Intent intent = new Intent(houseq6.this, houseq7.class);
                startActivity(intent);
            }
        });
